...
plt.annotate(text='a=' + str(round(point_left[0],3)), xy=(point_left, plt.ylim()[0]), fontsize=10)
plt.annotate(text='b=' + str(round(point_right[0],3)), xy=(point_right, plt.ylim()[0]), fontsize=10)
plt.annotate(text='R^2=' + str(round(r2, 2)) + ' MSE=' + str(round(mse, 2))+' α='+str(round(math.degrees(math.atan(a[0])),2))+'$^o$',
